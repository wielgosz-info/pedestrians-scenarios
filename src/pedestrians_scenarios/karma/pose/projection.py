...
def project_pose(world_pose: PoseDict, camera_transform: carla.Transform, km_camera: Union[KarmaCamera, carla.Sensor]) -> PoseDict:
    """
    ...
    camera_ct = ct.Camera(
        ct.RectilinearProjection(
            ...
            image_height_px=int(km_camera.attributes['image_size_x']),
    ...
    return dict(zip(CARLA_SKELETON, projection))
