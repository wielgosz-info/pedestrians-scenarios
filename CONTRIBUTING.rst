...
Welcome to ``pedestrians-scenarios`` contributor's guide.
...
If you experience bugs or general issues with ``pedestrians-scenarios``, please have a look
...
You can help improve ``pedestrians-scenarios`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pedestrians-scenarios`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pedestrians-scenarios``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n pedestrians-scenarios python=3 six virtualenv pytest pytest-cov
    conda activate pedestrians-scenarios
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pedestrians-scenarios.git
    cd pedestrians-scenarios
...
#. Install |pre-commit|_::
   ...
   ``pedestrians-scenarios`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pedestrians-scenarios
.. _issue tracker: https://github.com/<USERNAME>/pedestrians-scenarios/issues
.. <-- end -->
